...
The element `EducationReference` needs to be used in the procurement process, not in the job application process.
...
<4> Education period
<5> Registration type
<6> Registration type, connected to the registration type
