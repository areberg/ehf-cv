...
<2> Work experience requirement - indicate whether a candidate needs to fulfill the work experience requirement. According to codelist Requirement code (chapter 5.11).
<3> Position level
...
<8> Period
<9> Position percent
<10> Role in work experience according to code list Classification of Occupations (Styrk98) (chapter 5.15)
...
----
<1> Work experience identifier
<2> Position level according to codelist Position level (chapter 5.9)
