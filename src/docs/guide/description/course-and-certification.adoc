...
<2> Certification requirement - indicate whether a candidate needs to fulfill the course requirement
...
The element `CourseReference` and `CertificationReference` needs to be used in the procurement process, not in the job application
