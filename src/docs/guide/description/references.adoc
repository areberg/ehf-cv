...
The element `cv:RequestReference` must be used as a reference to the corresponding reference requirement in the CV request.
...
----
<1> Reference identifier
<2> Electronic address identifier. schemeID according to codelist Electronic address identifier (EAID) (chapter 5.18)
<3> Party name
