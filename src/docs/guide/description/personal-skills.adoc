...
The element `cv:PersonalSkillsReference` needs to be used as a reference to the corresponding personal skill requirement in the
CV request.
...
.Example of a description of personal skill in CV as a response to requested personal skills in CV request
[source, xml, indent=0]
----
