...
A clearance must include either element `cv-req:Type` or `cv-req:Title`, not both. Use type if the specific
clearance is defined in the clearance codelist, otherwise use the title.
...
<2> Clearance requirement - indicate whether a candidate needs to fulfill the clearance requirement.  According to codelist Requirement code (chapter 5.11).
<3> Clearance title
<4> Expiration date
...
<1> Clearance identifier
<2> Clearance requirement - indicate whether a candidate needs to fulfill the clearance requirement.  According to codelist Requirement code (chapter 5.11).
<3> Clearance type according to codelist Clearance type (chapter 5.3)
<4> Expiration date
...
clearance. 
The element `cv:ClearanceReference` must be used as a reference to the corresponding clearance requirement in the CV request.
...
----
<1> Clearance identifier
<2> Clearance type according to codelist Clearance type (chapter 5.3)
<3> Clearance level according to codelist Clearance level (chapter 5.2)
