...
A clearance must include the element `cv-req:Type`to specify the type of clearance requested.
...
<3> Clearance title, see examples below
...
----
<1> Clearance identifier
<2> Clearance title, see examples below
